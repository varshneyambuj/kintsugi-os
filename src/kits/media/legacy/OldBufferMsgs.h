...
/** @file OldBufferMsgs.h
    @brief Legacy message protocol opcodes exchanged between a BSubscriber and
           an R5-era buffer-stream server (e.g. the audio_server). Deprecated;
