 ...
 * MIT License. Copyright 2013, Haiku, Inc. All rights reserved.
 */

/** @file LibsolvSolver.h
    @brief BSolver implementation backed by libsolv for dependency resolution. */
...
/**
 * @brief BSolver backend that drives libsolv's pool/solver to compute
 *        install, uninstall, update, and verification plans for the package
 *        kit.
 */
