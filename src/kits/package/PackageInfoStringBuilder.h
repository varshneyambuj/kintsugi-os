...
/** @file PackageInfoStringBuilder.h
    @brief Inline helper that serialises BPackageInfo fields into ".PackageInfo" text. */
...
/**
 * @brief Header-only helper that serialises BPackageInfo attributes into the
 *        textual ".PackageInfo" representation, applying quoting and escaping
 *        as required.
 */
