...
/** @file ValidateChecksumJob.h
    @brief BJob that compares an expected and computed checksum for a fetched file. */
...
/**
 * @brief Job that fetches an expected and a computed checksum via accessors
 *        and reports whether they agree, optionally failing the job on a
 *        mismatch.
 */
