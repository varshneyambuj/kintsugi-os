...
/** @file CompanyIdentifiers.h
 *  @brief Table of Bluetooth SIG-assigned company identifier strings, indexed by the 16-bit manufacturer code. */

// https://www.bluetooth.com/specifications/assigned-numbers/company-identifiers

/** @brief Null-terminated string table mapping Bluetooth SIG company identifier codes to
 *         human-readable manufacturer names; index 0 corresponds to manufacturer code 0x0000. */
