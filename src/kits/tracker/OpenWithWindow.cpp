...
/**
 * @file OpenWithWindow.cpp
 * @brief "Open With" container window for choosing an application to open files.
 *
 * OpenWithContainerWindow displays an OpenWithPoseView (a specialised
 * BPoseView) populated with applications that can handle the dragged entries.
 * Selecting an app and clicking Open (or Open and Make Default) launches the
 * files and optionally sets the preferred application on each entry's MIME type.
 *
 * @see BContainerWindow, BPoseView, OpenWithPoseView
 */
...
/**
 * @brief Construct an OpenWithContainerWindow for the given set of entries.
 *
 * @param entriesToOpen  Message containing the "refs" to be opened; ownership taken.
 * @param windowList     Global Tracker window list.
 */
