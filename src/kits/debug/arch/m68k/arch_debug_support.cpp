 ...
 * @brief Architecture-specific debug support stubs for m68k.
 *
 * Provides m68k implementations of the architecture-dependent debug helper
 * functions used by the debug kit. Both functions currently return B_ERROR
 * as the m68k port is not fully implemented yet.
 *
...
/** @brief Standard two-word stack frame layout used on m68k. */
struct stack_frame {
