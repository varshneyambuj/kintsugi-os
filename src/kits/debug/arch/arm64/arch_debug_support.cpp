 ...
 * @brief Architecture-specific debug support stubs for ARM64.
 *
 * Provides ARM64 implementations of the architecture-dependent debug helper
 * functions used by the debug kit. Both functions currently return B_ERROR as
 * this architecture's debug register access is not yet implemented.
 *
 ...
 * extracts the program counter and frame pointer. On ARM64 this is not yet
 * implemented.
 *
 ...
 * @a stackFrameAddress and fills in @a stackFrameInfo accordingly. On ARM64
