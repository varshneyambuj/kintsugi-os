 ...
 * @brief Architecture-specific debug support stubs for MIPS (little-endian).
 *
 * Provides MIPSEL implementations of the architecture-dependent debug helper
 * functions used by the debug kit. Both functions currently return B_ERROR
 * as the MIPS little-endian port is not yet implemented.
 *
