 ...
 * MIT License. Copyright 2009-2016, Ingo Weinhold; Copyright 2010-2015, Rene Gollent.
 */

/** @file DebuggerInterface.h
    @brief Abstract back-end contract bridging the debugger UI to live or post-mortem teams. */
...
/** @brief Pure virtual interface that abstracts the debugger back-end so that
           local, network, and core-file targets can be driven through a single
           contract for events, control, and memory access. */
