...
/** @file ArchitectureX8664.h
    @brief x86_64 backend declaration for the architecture-neutral Architecture base. */
...
/** @brief Bitmask flags describing optional x86_64 CPU features. */
enum {
...
/** @brief x86_64 (AMD64) implementation of the architecture-neutral Architecture interface. */
