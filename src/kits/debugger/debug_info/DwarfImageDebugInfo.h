 ...
 * MIT License. Copyright 2009-2018, Haiku.
 * Original authors: Ingo Weinhold, Rene Gollent.
 */

/** @file DwarfImageDebugInfo.h
    @brief DWARF-backed SpecificImageDebugInfo: enumerates functions, looks
           up types and source statements, and unwinds frames using the
           DWARF data parsed for one image. */
...
/** @brief Per-image DWARF backend that drives function enumeration, type
           lookups, statement decoding, and frame unwinding from a parsed
           DwarfFile. */
...
public:
	...
	virtual						~DwarfImageDebugInfo();
			...
			/** @brief Returns the offset between in-file and runtime
			           addresses for this image. */
