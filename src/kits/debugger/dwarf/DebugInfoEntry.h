...
// TODO: Handle (ignore?) DW_AT_description here?
	...
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(string_length_bit_size)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(string_length_byte_size)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(rank)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(str_offsets_base)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(addr_base)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(rnglists_base)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(dwo_name)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(reference)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(rvalue_reference)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(macros)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(call_all_calls)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(call_all_source_calls)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(call_all_tail_calls)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(call_return_pc)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(call_value)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(call_origin)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(call_parameter)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(call_pc)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(call_tail_call)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(call_target)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(call_target_clobbered)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(call_data_location)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(call_data_value)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(noreturn)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(alignment)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(export_symbols)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(deleted)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(defaulted)
	DECLARE_DEBUG_INFO_ENTRY_ATTR_SETTER(loclists_base)
