...
/**
 * @file ApplicationTypeWindow.h
 * @brief Editor window for the BAppFileInfo of an application file
 *        (signature, flags, version, supported MIME types, icons).
 */
...
/**
 * @brief Window that edits the application metadata stored in a single
 *        executable's BAppFileInfo and writes the changes back to disk.
 */
