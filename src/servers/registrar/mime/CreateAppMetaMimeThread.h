 ...
 *  @brief Thread that scans directories to create application meta-MIME type entries. */
...
/** @brief Traverses a directory tree creating MIME metadata for application files. */
...
public:
	...
	/** @brief Processes a single entry to create its application meta-MIME type. */
