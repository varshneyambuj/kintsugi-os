...
/** @file InitTemporaryDirectoryJob.h
 *  @brief Boot job that creates and clears the temporary directory at startup. */
...
/** @brief Boot job that ensures the temporary directory exists and is empty. */
class InitTemporaryDirectoryJob : public AbstractEmptyDirectoryJob {
public:
								InitTemporaryDirectoryJob();

protected:
	/** @brief Creates and clears the temporary directory. */
