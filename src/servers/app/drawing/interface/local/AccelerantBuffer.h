 ...
 * MIT License. Copyright 2005, Michael Lotz.
 */

/** @file AccelerantBuffer.h
    @brief RenderingBuffer wrapper for the live frame buffer exposed by a
           graphics-card accelerant. */
...
/** @brief RenderingBuffer that addresses graphics memory directly via the
           accelerant's frame_buffer_config. Two-buffer setups (where the
           card exposes an off-screen back buffer immediately below the
           visible region) are supported through fIsOffscreenBuffer. */
