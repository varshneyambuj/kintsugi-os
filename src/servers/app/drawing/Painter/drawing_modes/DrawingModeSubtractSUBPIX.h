...
/** @file DrawingModeSubtractSUBPIX.h
    @brief Subpixel horizontal solid span variant of B_OP_SUBTRACT. */
...
/** @brief Subpixel horizontal solid span for B_OP_SUBTRACT; consumes
           three coverage bytes per output pixel. */
void
