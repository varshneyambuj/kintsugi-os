...
/** @file DrawingModeSelectSUBPIX.h
    @brief Subpixel horizontal solid span variant of B_OP_SELECT. */
...
/** @brief Subpixel horizontal solid span for B_OP_SELECT; consumes
