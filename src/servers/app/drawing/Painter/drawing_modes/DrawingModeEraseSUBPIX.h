...
/** @file DrawingModeEraseSUBPIX.h
    @brief Subpixel horizontal solid span variant of B_OP_ERASE. */
...
/** @brief Subpixel horizontal solid span for B_OP_ERASE; consumes three
