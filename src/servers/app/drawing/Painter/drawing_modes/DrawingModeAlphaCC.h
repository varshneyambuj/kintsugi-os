...
/** @file DrawingModeAlphaCC.h
    @brief Blend functions for B_OP_ALPHA + B_CONSTANT_ALPHA +
           B_ALPHA_COMPOSITE: composes the high color over a possibly
           semi-transparent destination using the high color's alpha
           channel as a constant. */
...
/** @brief Blends one B_OP_ALPHA / Constant-Composite pixel using the high
           color's alpha as a constant src factor. */
void
...
/** @brief Blends a horizontal run using B_OP_ALPHA Constant-Composite
           with a single AA cover. */
void
