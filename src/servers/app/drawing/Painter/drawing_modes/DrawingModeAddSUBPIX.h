...
/** @file DrawingModeAddSUBPIX.h
    @brief Subpixel horizontal solid span variant of B_OP_ADD. */
...
/** @brief Subpixel horizontal solid span for B_OP_ADD; consumes three
           coverage bytes per output pixel and applies saturating
           per-channel addition with the per-subpixel alphas. */
void
