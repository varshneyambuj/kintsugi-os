...
/** @file DrawingModeAlphaCOSolid.h
    @brief Solid-pattern fast path for B_OP_ALPHA Constant-Overlay. */
...
/** @brief Solid-pattern B_OP_ALPHA Constant-Overlay blend for one
           pixel. */
void
...
/** @brief Solid-pattern B_OP_ALPHA Constant-Overlay horizontal-line
           blend. */
void
